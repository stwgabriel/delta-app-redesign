...
export const comorbidities_template = [
  { text: "Hipertensao arterial", field: "cm_arterial_hypertension" },
  { text: "Diabetes melitus", field: "cm_diabetes_mellitus" },
  { text: "Dislipidemia", field: "cm_dyslipidemia" },
  {
    text: "Doenca renal crônica",
    field: "cm_chronic_kidney_disease",
  },
  { text: "Tabagismo", field: "cm_smoking" },
  { text: "Epilepsia", field: "cm_epilepsy" },
  {
    text: "Transtorno psiquiátrico",
    field: "cm_psychiatric_disorder",
  },
  { text: "Drogadição", field: "cm_drug_addiction" },
